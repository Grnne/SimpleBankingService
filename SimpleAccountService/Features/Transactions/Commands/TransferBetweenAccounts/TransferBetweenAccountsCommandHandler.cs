...
[UsedImplicitly]
public class TransferBetweenAccountsCommandHandler(ITransactionService service) : IRequestHandler<TransferBetweenAccountsCommand, MbResult<List<TransactionDto>>>
{
